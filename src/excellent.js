...
(function () {
    ...
    function ERoot() {
         ...
         * is an alias controller. And this method simplifies creation of such controllers, while also giving the option
         * to re-configure extended controllers.
         *
         ...
         * resort to using a pre-configured alias.
         *
         * For the same reason, sometimes you may even want to create an alias for a single controller, if you want
         * to shorten its long name, and/or re-configure at the same time:
         *
         * ```js
